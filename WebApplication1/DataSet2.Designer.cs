...
namespace WebApplication1.DataSet2TableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Employees] ([LastName], [FirstName], [Title]) VALUES (@LastName, @Fi" +
                "rstName, @Title)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        LastName, FirstName, EmployeeID, Title\r\nFROM            Employees";
        ...
        public virtual int Update(string LastName, string FirstName, string Title, int Original_EmployeeID) {
            if ((LastName == null)) {
                throw new global::System.ArgumentNullException("LastName");
            }
            else {
